  ...
  Widget courseBlock(int index, String videoTitle) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isPlaying ? AppTheme.blueaccent.withOpacity(0.1) : Colors.white.withOpacity(0.9),
      ...
      child: ListTile(
        ...
        title: Text(
          videoTitle,
          style: AppTheme.body_grey.copyWith(
            fontSize: 14,
            fontWeight: isPlaying ? FontWeight.bold : FontWeight.w500,
            color: isPlaying ? AppTheme.blueaccent : AppTheme.body_grey.color,
          ),
        ),
        trailing: Icon(
